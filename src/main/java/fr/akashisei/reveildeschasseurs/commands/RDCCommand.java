...
public class RDCCommand implements CommandExecutor {
    ...
    private void handleQuests(Player player) {
        ...
        for (Quest quest : quests) {
            ...
            player.sendMessage(ChatColor.GRAY + "Niveau minimum: " + quest.getRequiredLevel());
            player.sendMessage(ChatColor.GRAY + "Récompense: " + quest.getReward() + " XP, " + 
                             quest.getRewardReward().getBaseMoney() + " coins");
        }
    }
