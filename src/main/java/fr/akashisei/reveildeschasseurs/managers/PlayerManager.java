...
public class PlayerManager {
    ...
    private PlayerData loadPlayerData(File file) {
        ...
        PlayerData data = new PlayerData(UUID.fromString(file.getName().replace(".yml", "")));
        ...
        data.setCompletedQuests(config.getInt("completed_quests", 0));
        return data;
    }
    ...
    public void savePlayerData(PlayerData data) {
        ...
        config.set("completed_quests", data.getCompletedQuests());
    ...
    private void checkRankUp(PlayerData data) {
        ...
        if (!currentRank.equals(newRank)) {
            ...
            plugin.getServer().getPlayer(data.getUuid()).sendMessage(
